...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("DisruptionsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheDisruptionsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheDisruptionsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheDisruptionsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheDisruptionsListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheDisruptionsListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheDisruptionsListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheDisruptionsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheDisruptionsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheDisruptionsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheDisruptionsObjectPageGenerated.iSeeThisPage();
        });
